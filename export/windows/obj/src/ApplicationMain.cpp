...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Pixel Climber",c8,3c,88,fb),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("456",95,a3,27,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("Conecat",f3,f1,dc,dc));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Pixel Climber",c8,3c,88,fb));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Pixel Climber",c8,3c,88,fb));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.conecat.pixelClimber",44,23,ff,b2));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Pixel Climber",c8,3c,88,fb))
