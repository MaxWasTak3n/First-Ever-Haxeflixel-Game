...
HX_LOCAL_STACK_FRAME(_hx_pos_1f119275e66a7b90_60_clickPlay,"MenuState","clickPlay",0x5f6a9ec0,"MenuState.clickPlay","MenuState.hx",60,0xdfbcb22c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_1f119275e66a7b90_68_clickOptions,"MenuState","clickOptions",0xe3ab4a12,"MenuState.clickOptions","MenuState.hx",68,0xdfbcb22c)
HX_LOCAL_STACK_FRAME(_hx_pos_1f119275e66a7b90_66_clickOptions,"MenuState","clickOptions",0xe3ab4a12,"MenuState.clickOptions","MenuState.hx",66,0xdfbcb22c)
HX_LOCAL_STACK_FRAME(_hx_pos_1f119275e66a7b90_75_clickExit,"MenuState","clickExit",0x582e67ea,"MenuState.clickExit","MenuState.hx",75,0xdfbcb22c)
...
HXLINE(  22)		{
HXLINE(  22)			 ::flixel::text::FlxText _this = this->titleText;
HXDLIN(  22)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN(  22)			if (::hx::IsNull( axes )) {
HXLINE(  22)				axes = ::flixel::util::FlxAxes_obj::XY_dyn();
            			}
...
HXLINE(  26)		this->playButton->onUp->sound = ::flixel::FlxG_obj::sound->load(HX_("assets/sounds/select.wav",99,31,ec,2e),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(  27)		 ::flixel::ui::FlxButton _hx_tmp2 = this->playButton;
HXDLIN(  27)		Float _hx_tmp3 = ((( (Float)(::flixel::FlxG_obj::width) ) / ( (Float)(2) )) - ( (Float)(10) ));
HXDLIN(  27)		_hx_tmp2->set_x((_hx_tmp3 - this->playButton->get_width()));
HXLINE(  28)		 ::flixel::ui::FlxButton _hx_tmp4 = this->playButton;
HXDLIN(  28)		int _hx_tmp5 = ::flixel::FlxG_obj::height;
HXDLIN(  28)		_hx_tmp4->set_y(((( (Float)(_hx_tmp5) ) - this->playButton->get_height()) - ( (Float)(10) )));
...
HXLINE(  33)		 ::flixel::ui::FlxButton _hx_tmp6 = this->optionsButton;
HXDLIN(  33)		int _hx_tmp7 = ::flixel::FlxG_obj::height;
HXDLIN(  33)		_hx_tmp6->set_y(((( (Float)(_hx_tmp7) ) - this->optionsButton->get_height()) - ( (Float)(10) )));
HXLINE(  34)		this->add(this->optionsButton);
HXLINE(  37)		this->exitButton =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,(::flixel::FlxG_obj::width - 28),8,HX_("X",58,00,00,00),this->clickExit_dyn());
HXLINE(  38)		this->exitButton->loadGraphic(HX_("assets/images/button.png",98,1b,b6,cd),true,20,20,null(),null());
HXLINE(  39)		this->add(this->exitButton);
HXLINE(  42)		if (::hx::IsNull( ::flixel::FlxG_obj::sound->music )) {
HXLINE(  47)			::flixel::FlxG_obj::sound->playMusic(HX_("assets/music/HaxeFlixel_Tutorial_Game.ogg",8d,56,76,f8),1,true,null());
            		}
HXLINE(  51)		::flixel::FlxG_obj::camera->fade(-16777216,((Float)0.33),true,null(),null());
...
void MenuState_obj::clickPlay(){
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_1f119275e66a7b90_60_clickPlay)
HXLINE(  60)			 ::flixel::FlxState nextState =  ::PlayState_obj::__alloc( HX_CTX ,null());
HXDLIN(  60)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(  60)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_STACKFRAME(&_hx_pos_1f119275e66a7b90_58_clickPlay)
HXDLIN(  58)		::flixel::FlxG_obj::camera->fade(-16777216,((Float)0.33),false, ::Dynamic(new _hx_Closure_0()),null());
            	}
...
void MenuState_obj::clickOptions(){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_1f119275e66a7b90_68_clickOptions)
HXLINE(  68)			 ::flixel::FlxState nextState =  ::OptionsState_obj::__alloc( HX_CTX ,null());
...
HXLINE(  68)				::flixel::FlxG_obj::game->_requestedState = nextState;
            	...
            	HX_STACKFRAME(&_hx_pos_1f119275e66a7b90_66_clickOptions)
HXDLIN(  66)		::flixel::FlxG_obj::camera->fade(-16777216,((Float)0.33),false, ::Dynamic(new _hx_Closure_0()),null());
            	}
...
void MenuState_obj::clickExit(){
            	HX_STACKFRAME(&_hx_pos_1f119275e66a7b90_75_clickExit)
HXDLIN(  75)		::Sys_obj::exit(0);
            	}
