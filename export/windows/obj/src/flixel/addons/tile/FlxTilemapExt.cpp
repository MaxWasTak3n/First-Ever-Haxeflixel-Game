...
HXLINE( 239)							 ::openfl::geom::Point _hx_tmp = this->_flashPoint;
HXDLIN( 239)							_hx_tmp->x = (_hx_tmp->x + this->_tileWidth);
            						}
...
HXLINE( 247)					 ::openfl::geom::Point _hx_tmp = this->_flashPoint;
HXDLIN( 247)					_hx_tmp->y = (_hx_tmp->y + this->_tileHeight);
            				}
            			}
            		}
...
HXLINE( 280)					{
HXLINE( 280)						 ::flixel::addons::tile::FlxTileSpecial _g = tile;
HXDLIN( 280)						_g->set_currTileId((_g->currTileId - this->_startingIndex));
            					}
...
HXLINE( 387)								_hx_tmp = ::Std_obj::isOfType(Object,( ( ::Dynamic)(tile->filter) ));
            							}
            							else {
...
HXLINE( 396)							_hx_tmp = ::Std_obj::isOfType(Object,( ( ::Dynamic)(tile->filter) ));
            						}
            						else {
...
HXLINE( 620)					 ::flixel::math::FlxPoint _g = Object->velocity;
HXDLIN( 620)					_g->set_x((_g->x * (( (Float)(1) ) - ((( (Float)(1) ) - this->_slopeSlowDownFactor) * ( (Float)(3) )))));
            				}
            			}
            		}
            		else {
...
HXLINE( 627)					 ::flixel::math::FlxPoint _g = Object->velocity;
HXDLIN( 627)					_g->set_x((_g->x * (( (Float)(1) ) - ((( (Float)(1) ) - this->_slopeSlowDownFactor) * ( (Float)(3) )))));
            				}
            			}
            			else {
...
HXLINE( 633)						 ::flixel::math::FlxPoint _g = Object->velocity;
HXDLIN( 633)						_g->set_x((_g->x * this->_slopeSlowDownFactor));
            					}
            				}
            				else {
...
HXLINE( 639)							 ::flixel::math::FlxPoint _g = Object->velocity;
HXDLIN( 639)							_g->set_x((_g->x * this->_slopeSlowDownFactor));
            						}
            					}
            					else {
...
HXLINE( 644)							 ::flixel::math::FlxPoint _g = Object->velocity;
HXDLIN( 644)							_g->set_x((_g->x * this->_slopeSlowDownFactor));
            						}
            					}
            				}
            			}
...
HXLINE( 693)				 ::flixel::math::FlxPoint _g = Object->velocity;
HXDLIN( 693)				_g->set_x((_g->x * (( (Float)(1) ) - ((( (Float)(1) ) - this->_slopeSlowDownFactor) * ( (Float)(3) )))));
            			}
            		}
            		else {
...
HXLINE( 699)					 ::flixel::math::FlxPoint _g = Object->velocity;
HXDLIN( 699)					_g->set_x((_g->x * (( (Float)(1) ) - ((( (Float)(1) ) - this->_slopeSlowDownFactor) * ( (Float)(3) )))));
            				}
            			}
            			else {
...
HXLINE( 705)						 ::flixel::math::FlxPoint _g = Object->velocity;
HXDLIN( 705)						_g->set_x((_g->x * this->_slopeSlowDownFactor));
            					}
            				}
            				else {
...
HXLINE( 711)							 ::flixel::math::FlxPoint _g = Object->velocity;
HXDLIN( 711)							_g->set_x((_g->x * this->_slopeSlowDownFactor));
            						}
            					}
            					else {
...
HXLINE( 716)							 ::flixel::math::FlxPoint _g = Object->velocity;
HXDLIN( 716)							_g->set_x((_g->x * this->_slopeSlowDownFactor));
            						}
            					}
            				}
            			}
