...
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_224_updateAlpha,"CombatHUD","updateAlpha",0x5f8f306a,"CombatHUD.updateAlpha","CombatHUD.hx",224,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_222_updateAlpha,"CombatHUD","updateAlpha",0x5f8f306a,"CombatHUD.updateAlpha","CombatHUD.hx",222,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_231_finishFadeIn,"CombatHUD","finishFadeIn",0xdde03bbf,"CombatHUD.finishFadeIn","CombatHUD.hx",231,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_242_finishFadeOut,"CombatHUD","finishFadeOut",0x46589f74,"CombatHUD.finishFadeOut","CombatHUD.hx",242,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_251_updatePlayerHealth,"CombatHUD","updatePlayerHealth",0x976fb751,"CombatHUD.updatePlayerHealth","CombatHUD.hx",251,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_257_update,"CombatHUD","update",0xf0e37654,"CombatHUD.update","CombatHUD.hx",257,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_267_updateKeyboardInput,"CombatHUD","updateKeyboardInput",0x9c6baeef,"CombatHUD.updateKeyboardInput","CombatHUD.hx",267,0x215789db)
...
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_305_updateTouchInput,"CombatHUD","updateTouchInput",0x876dd33f,"CombatHUD.updateTouchInput","CombatHUD.hx",305,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_330_movePointer,"CombatHUD","movePointer",0x81fe1981,"CombatHUD.movePointer","CombatHUD.hx",330,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_337_makeChoice,"CombatHUD","makeChoice",0x892305ba,"CombatHUD.makeChoice","CombatHUD.hx",337,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_352_makeChoice,"CombatHUD","makeChoice",0x892305ba,"CombatHUD.makeChoice","CombatHUD.hx",352,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_411_enemyAttack,"CombatHUD","enemyAttack",0x20228805,"CombatHUD.enemyAttack","CombatHUD.hx",411,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_442_updateDamageY,"CombatHUD","updateDamageY",0x1e0fb516,"CombatHUD.updateDamageY","CombatHUD.hx",442,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_450_updateDamageAlpha,"CombatHUD","updateDamageAlpha",0x79796e7b,"CombatHUD.updateDamageAlpha","CombatHUD.hx",450,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_458_doneDamageIn,"CombatHUD","doneDamageIn",0x0a5fc361,"CombatHUD.doneDamageIn","CombatHUD.hx",458,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_466_doneResultsIn,"CombatHUD","doneResultsIn",0x5b1790ae,"CombatHUD.doneResultsIn","CombatHUD.hx",466,0x215789db)
HX_LOCAL_STACK_FRAME(_hx_pos_94bd977f46f9a023_474_doneDamageOut,"CombatHUD","doneDamageOut",0x096fc592,"CombatHUD.doneDamageOut","CombatHUD.hx",474,0x215789db)
...
HXLINE( 154)			sprite->scrollFactor->set(null(),null());
...
HXLINE(  88)		this->background =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(120,120,-1,null(),null());
HXLINE(  89)		::flixel::util::FlxSpriteUtil_obj::drawRect(this->background,( (Float)(1) ),( (Float)(1) ),( (Float)(118) ),( (Float)(44) ),-16777216,null(),null());
HXLINE(  90)		::flixel::util::FlxSpriteUtil_obj::drawRect(this->background,( (Float)(1) ),( (Float)(46) ),( (Float)(118) ),( (Float)(73) ),-16777216,null(),null());
HXLINE(  91)		{
HXLINE(  91)			 ::flixel::FlxSprite _this = this->background;
HXDLIN(  91)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::XY_dyn();
...
HXLINE( 109)		Float _hx_tmp2 = this->playerSprite->y;
HXDLIN( 109)		this->playerHealthCounter =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,((_hx_tmp2 + this->playerSprite->get_height()) + 2),0,HX_("3 / 3",95,2f,ba,72),8,null());
HXLINE( 110)		this->playerHealthCounter->set_alignment(HX_("center",d5,25,db,05));
HXLINE( 111)		 ::flixel::text::FlxText _hx_tmp3 = this->playerHealthCounter;
HXDLIN( 111)		Float _hx_tmp4 = (this->playerSprite->x + 4);
HXDLIN( 111)		_hx_tmp3->set_x((_hx_tmp4 - (this->playerHealthCounter->get_width() / ( (Float)(2) ))));
...
HXLINE( 126)		Float _hx_tmp5 = (this->background->x + 10);
HXDLIN( 126)		Float _hx_tmp6 = this->choices->get(::Choice_obj::FIGHT_dyn()).StaticCast<  ::flixel::text::FlxText >()->y;
HXDLIN( 126)		this->pointer =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,_hx_tmp5,((_hx_tmp6 + (this->choices->get(::Choice_obj::FIGHT_dyn()).StaticCast<  ::flixel::text::FlxText >()->get_height() / ( (Float)(2) ))) - ( (Float)(8) )),HX_("assets/images/pointer.png",ad,e2,d4,86));
HXLINE( 127)		this->pointer->set_visible(false);
HXLINE( 128)		this->add(this->pointer);
HXLINE( 131)		this->damages = ::Array_obj< ::Dynamic>::__new();
HXLINE( 132)		::Array< ::Dynamic> _hx_tmp7 = this->damages;
HXDLIN( 132)		_hx_tmp7->push( ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,40,null(),null(),null()));
HXLINE( 133)		::Array< ::Dynamic> _hx_tmp8 = this->damages;
HXDLIN( 133)		_hx_tmp8->push( ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,40,null(),null(),null()));
HXLINE( 134)		{
HXLINE( 134)			int _g = 0;
...
HXLINE( 162)		this->fledSound = ::flixel::FlxG_obj::sound->load(HX_("assets/sounds/fled.wav",82,28,c9,3d),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 163)		this->hurtSound = ::flixel::FlxG_obj::sound->load(HX_("assets/sounds/hurt.wav",6c,32,7c,8f),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 164)		this->loseSound = ::flixel::FlxG_obj::sound->load(HX_("assets/sounds/lose.wav",32,db,1d,3e),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 165)		this->missSound = ::flixel::FlxG_obj::sound->load(HX_("assets/sounds/miss.wav",d9,a3,6b,8d),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 166)		this->selectSound = ::flixel::FlxG_obj::sound->load(HX_("assets/sounds/select.wav",99,31,ec,2e),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 167)		this->winSound = ::flixel::FlxG_obj::sound->load(HX_("assets/sounds/win.wav",9b,6f,bc,c5),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 168)		this->combatSound = ::flixel::FlxG_obj::sound->load(HX_("assets/sounds/combat.wav",d1,22,6e,57),null(),null(),null(),null(),null(),null(),null(),null());
            	}
...
HXLINE( 184)			 ::openfl::display::Sprite _hx_tmp = ::flixel::FlxG_obj::camera->canvas;
HXDLIN( 184)			screenPixels->draw(_hx_tmp, ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,1,0,0,1,0,0),null(),null(),null(),null());
            		}
...
HXDLIN( 189)		 ::openfl::geom::Point _hx_tmp =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 189)		screenPixels->applyFilter(screenPixels,screenPixels1,_hx_tmp, ::openfl::filters::ColorMatrixFilter_obj::__alloc( HX_CTX ,::Array_obj< Float >::__new(20)->init(0,rc)->init(1,gc)->init(2,bc)->init(3,0)->init(4,0)->init(5,rc)->init(6,gc)->init(7,bc)->init(8,0)->init(9,0)->init(10,rc)->init(11,gc)->init(12,bc)->init(13,0)->init(14,0)->init(15,0)->init(16,0)->init(17,0)->init(18,1)->init(19,0)));
...
HXLINE( 199)		int _hx_tmp1;
HXDLIN( 199)		if (::hx::IsEq( enemy->type,::EnemyType_obj::REGULAR_dyn() )) {
HXLINE( 199)			_hx_tmp1 = 2;
            		}
            		else {
HXLINE( 199)			_hx_tmp1 = 4;
            		}
HXDLIN( 199)		this->enemyMaxHealth = (this->enemyHealth = _hx_tmp1);
HXLINE( 200)		this->enemyHealthBar->set_value(( (Float)(100) ));
HXLINE( 201)		this->enemySprite->changeType(enemy->type);
HXLINE( 204)		this->wait = true;
HXLINE( 205)		this->results->set_text(HX_("",00,00,00,00));
HXLINE( 206)		this->pointer->set_visible(false);
HXLINE( 207)		this->results->set_visible(false);
HXLINE( 208)		this->outcome = ::Outcome_obj::NONE_dyn();
HXLINE( 209)		this->selected = ::Choice_obj::FIGHT_dyn();
HXLINE( 210)		this->movePointer();
HXLINE( 212)		this->set_visible(true);
HXLINE( 215)		::flixel::tweens::FlxTween_obj::num(( (Float)(0) ),( (Float)(1) ),((Float).66), ::Dynamic(::hx::Anon_obj::Create(2)
...
void CombatHUD_obj::updateAlpha(Float alpha){
            		...
            		void _hx_run( ::flixel::FlxSprite sprite){
            			HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_224_updateAlpha)
HXLINE( 224)			sprite->set_alpha(alpha);
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_222_updateAlpha)
HXLINE( 223)		this->alpha = alpha;
HXLINE( 224)		this->forEach( ::Dynamic(new _hx_Closure_0(alpha)),null());
            	}
...
void CombatHUD_obj::finishFadeIn( ::flixel::tweens::FlxTween _){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_231_finishFadeIn)
HXLINE( 232)		this->set_active(true);
HXLINE( 233)		this->wait = false;
HXLINE( 234)		this->pointer->set_visible(true);
HXLINE( 235)		this->selectSound->play(null(),null(),null());
            	}
...
void CombatHUD_obj::finishFadeOut( ::flixel::tweens::FlxTween _){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_242_finishFadeOut)
HXLINE( 243)		this->set_active(false);
...
void CombatHUD_obj::updatePlayerHealth(){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_251_updatePlayerHealth)
HXLINE( 252)		this->playerHealthCounter->set_text((this->playerHealth + HX_(" / 3",e2,99,4a,15)));
HXLINE( 253)		 ::flixel::text::FlxText _hx_tmp = this->playerHealthCounter;
HXDLIN( 253)		Float _hx_tmp1 = (this->playerSprite->x + 4);
HXDLIN( 253)		_hx_tmp->set_x((_hx_tmp1 - (this->playerHealthCounter->get_width() / ( (Float)(2) ))));
            	}
...
void CombatHUD_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_257_update)
HXLINE( 258)		if (!(this->wait)) {
HXLINE( 260)			this->updateKeyboardInput();
HXLINE( 261)			this->updateTouchInput();
            		}
...
void CombatHUD_obj::updateKeyboardInput(){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_267_updateKeyboardInput)
HXLINE( 270)		bool up = false;
HXLINE( 271)		bool down = false;
HXLINE( 272)		bool fire = false;
HXLINE( 275)		if (::flixel::FlxG_obj::keys->checkKeyArrayState(::Array_obj< int >::fromData( _hx_array_data_0c6cd4c3_11,3),-1)) {
HXLINE( 277)			fire = true;
            		}
            		else {
HXLINE( 279)			if (::flixel::FlxG_obj::keys->checkKeyArrayState(::Array_obj< int >::fromData( _hx_array_data_0c6cd4c3_12,2),-1)) {
HXLINE( 281)				up = true;
            			}
            			else {
HXLINE( 283)				if (::flixel::FlxG_obj::keys->checkKeyArrayState(::Array_obj< int >::fromData( _hx_array_data_0c6cd4c3_13,2),-1)) {
HXLINE( 285)					down = true;
            				}
            			}
            		}
HXLINE( 289)		if (fire) {
HXLINE( 291)			this->selectSound->play(null(),null(),null());
HXLINE( 292)			this->makeChoice();
            		}
            		else {
HXLINE( 294)			bool _hx_tmp;
HXDLIN( 294)			if (!(up)) {
HXLINE( 294)				_hx_tmp = down;
            			}
            			else {
HXLINE( 294)				_hx_tmp = true;
            			}
HXDLIN( 294)			if (_hx_tmp) {
HXLINE( 297)				 ::Choice _hx_tmp;
HXDLIN( 297)				if (::hx::IsEq( this->selected,::Choice_obj::FIGHT_dyn() )) {
HXLINE( 297)					_hx_tmp = ::Choice_obj::FLEE_dyn();
            				}
            				else {
HXLINE( 297)					_hx_tmp = ::Choice_obj::FIGHT_dyn();
            				}
HXDLIN( 297)				this->selected = _hx_tmp;
HXLINE( 298)				this->selectSound->play(null(),null(),null());
HXLINE( 299)				this->movePointer();
            			}
            		}
            	}
...
void CombatHUD_obj::updateTouchInput(){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_305_updateTouchInput)
            	}
...
void CombatHUD_obj::movePointer(){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_330_movePointer)
HXDLIN( 330)		 ::flixel::FlxSprite _hx_tmp = this->pointer;
HXDLIN( 330)		Float _hx_tmp1 = this->choices->get(this->selected).StaticCast<  ::flixel::text::FlxText >()->y;
HXDLIN( 330)		_hx_tmp->set_y(((_hx_tmp1 + (this->choices->get(this->selected).StaticCast<  ::flixel::text::FlxText >()->get_height() / ( (Float)(2) ))) - ( (Float)(8) )));
            	}
...
void CombatHUD_obj::makeChoice(){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_337_makeChoice)
HXLINE( 336)		 ::CombatHUD _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 338)		this->pointer->set_visible(false);
HXLINE( 339)		switch((int)(this->selected->_hx_getIndex())){
            			case (int)0: {
HXLINE( 345)				if ((::flixel::FlxG_obj::random->_hx_float(0,100,null()) < 85)) {
            					HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::CombatHUD,_gthis) HXARGC(1)
            					void _hx_run( ::flixel::tweens::FlxTween _){
            						HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_352_makeChoice)
HXLINE( 352)						::flixel::tweens::FlxTween_obj::tween(_gthis->enemySprite, ::Dynamic(::hx::Anon_obj::Create(1)
            							->setFixed(0,HX_("x",78,00,00,00),(_gthis->enemySprite->x - ( (Float)(4) )))),((Float)0.1),null());
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 348)					this->damages->__get(1).StaticCast<  ::flixel::text::FlxText >()->set_text(HX_("1",31,00,00,00));
HXLINE( 349)					::flixel::tweens::FlxTween_obj::tween(this->enemySprite, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 355)					this->hurtSound->play(null(),null(),null());
HXLINE( 356)					this->enemyHealth--;
HXLINE( 357)					this->enemyHealthBar->set_value(((( (Float)(this->enemyHealth) ) / ( (Float)(this->enemyMaxHealth) )) * ( (Float)(100) )));
            				}
            				else {
HXLINE( 362)					this->damages->__get(1).StaticCast<  ::flixel::text::FlxText >()->set_text(HX_("MISS!",a5,81,5a,86));
HXLINE( 363)					this->missSound->play(null(),null(),null());
            				}
HXLINE( 367)				 ::flixel::text::FlxText _hx_tmp = this->damages->__get(1).StaticCast<  ::flixel::text::FlxText >();
HXDLIN( 367)				Float _hx_tmp1 = (this->enemySprite->x + 2);
HXDLIN( 367)				_hx_tmp->set_x((_hx_tmp1 - (this->damages->__get(1).StaticCast<  ::flixel::text::FlxText >()->get_width() / ( (Float)(2) ))));
HXLINE( 368)				 ::flixel::text::FlxText _hx_tmp2 = this->damages->__get(1).StaticCast<  ::flixel::text::FlxText >();
HXDLIN( 368)				Float _hx_tmp3 = (this->enemySprite->y + 4);
HXDLIN( 368)				_hx_tmp2->set_y((_hx_tmp3 - (this->damages->__get(1).StaticCast<  ::flixel::text::FlxText >()->get_height() / ( (Float)(2) ))));
HXLINE( 369)				this->damages->__get(1).StaticCast<  ::flixel::text::FlxText >()->set_alpha(( (Float)(0) ));
HXLINE( 370)				this->damages->__get(1).StaticCast<  ::flixel::text::FlxText >()->set_visible(true);
HXLINE( 373)				if ((this->enemyHealth > 0)) {
HXLINE( 375)					this->enemyAttack();
            				}
HXLINE( 379)				::flixel::tweens::FlxTween_obj::num(this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >()->y,(this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >()->y - ( (Float)(12) )),1, ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::circOut_dyn())),this->updateDamageY_dyn());
HXLINE( 380)				::flixel::tweens::FlxTween_obj::num(( (Float)(0) ),( (Float)(1) ),((Float).2), ::Dynamic(::hx::Anon_obj::Create(2)
            			...
            			break;
            			case (int)1: {
HXLINE( 384)				if ((::flixel::FlxG_obj::random->_hx_float(0,100,null()) < 50)) {
HXLINE( 387)					this->outcome = ::Outcome_obj::ESCAPE_dyn();
HXLINE( 388)					this->results->set_text(HX_("ESCAPED!",1e,cd,18,52));
HXLINE( 389)					this->fledSound->play(null(),null(),null());
HXLINE( 390)					this->results->set_visible(true);
HXLINE( 391)					this->results->set_alpha(( (Float)(0) ));
HXLINE( 392)					::flixel::tweens::FlxTween_obj::tween(this->results, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 397)					this->enemyAttack();
HXLINE( 398)					::flixel::tweens::FlxTween_obj::num(this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >()->y,(this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >()->y - ( (Float)(12) )),1, ::Dynamic(::hx::Anon_obj::Create(1)
            						->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::circOut_dyn())),this->updateDamageY_dyn());
HXLINE( 399)					::flixel::tweens::FlxTween_obj::num(( (Float)(0) ),( (Float)(1) ),((Float).2), ::Dynamic(::hx::Anon_obj::Create(2)
            						->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::circInOut_dyn())
            						->setFixed(1,HX_("onComplete",f8,d4,7e,5d),this->doneDamageIn_dyn())),this->updateDamageAlpha_dyn());
            				}
            			}
...
void CombatHUD_obj::enemyAttack(){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_411_enemyAttack)
HXLINE( 413)		if ((::flixel::FlxG_obj::random->_hx_float(0,100,null()) < 30)) {
HXLINE( 416)			::flixel::FlxG_obj::camera->flash(-1,((Float).2),null(),null());
HXLINE( 417)			::flixel::FlxG_obj::camera->shake(((Float)0.01),((Float)0.2),null(),null(),null());
HXLINE( 418)			this->hurtSound->play(null(),null(),null());
HXLINE( 419)			this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >()->set_text(HX_("1",31,00,00,00));
HXLINE( 420)			this->playerHealth--;
HXLINE( 421)			this->updatePlayerHealth();
            		}
            		else {
HXLINE( 426)			this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >()->set_text(HX_("MISS!",a5,81,5a,86));
HXLINE( 427)			this->missSound->play(null(),null(),null());
            		}
HXLINE( 431)		 ::flixel::text::FlxText _hx_tmp = this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >();
HXDLIN( 431)		Float _hx_tmp1 = (this->playerSprite->x + 2);
HXDLIN( 431)		_hx_tmp->set_x((_hx_tmp1 - (this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >()->get_width() / ( (Float)(2) ))));
HXLINE( 432)		 ::flixel::text::FlxText _hx_tmp2 = this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >();
HXDLIN( 432)		Float _hx_tmp3 = (this->playerSprite->y + 4);
HXDLIN( 432)		_hx_tmp2->set_y((_hx_tmp3 - (this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >()->get_height() / ( (Float)(2) ))));
HXLINE( 433)		this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >()->set_alpha(( (Float)(0) ));
HXLINE( 434)		this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >()->set_visible(true);
            	}
...
void CombatHUD_obj::updateDamageY(Float damageY){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_442_updateDamageY)
HXDLIN( 442)		 ::flixel::text::FlxText _hx_tmp = this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >();
HXDLIN( 442)		_hx_tmp->set_y(this->damages->__get(1).StaticCast<  ::flixel::text::FlxText >()->set_y(damageY));
            	}
...
void CombatHUD_obj::updateDamageAlpha(Float damageAlpha){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_450_updateDamageAlpha)
HXDLIN( 450)		 ::flixel::text::FlxText _hx_tmp = this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >();
HXDLIN( 450)		_hx_tmp->set_alpha(this->damages->__get(1).StaticCast<  ::flixel::text::FlxText >()->set_alpha(damageAlpha));
            	}
...
void CombatHUD_obj::doneDamageIn( ::flixel::tweens::FlxTween _){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_458_doneDamageIn)
HXDLIN( 458)		::flixel::tweens::FlxTween_obj::num(( (Float)(1) ),( (Float)(0) ),((Float).66), ::Dynamic(::hx::Anon_obj::Create(3)
...
void CombatHUD_obj::doneResultsIn( ::flixel::tweens::FlxTween _){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_466_doneResultsIn)
HXDLIN( 466)		::flixel::tweens::FlxTween_obj::num(( (Float)(1) ),( (Float)(0) ),((Float).66), ::Dynamic(::hx::Anon_obj::Create(3)
            			->setFixed(0,HX_("startDelay",c1,af,3d,f3),1)
...
void CombatHUD_obj::doneDamageOut( ::flixel::tweens::FlxTween _){
            	HX_STACKFRAME(&_hx_pos_94bd977f46f9a023_474_doneDamageOut)
HXLINE( 475)		this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >()->set_visible(false);
HXLINE( 476)		this->damages->__get(1).StaticCast<  ::flixel::text::FlxText >()->set_visible(false);
HXLINE( 477)		this->damages->__get(0).StaticCast<  ::flixel::text::FlxText >()->set_text(HX_("",00,00,00,00));
HXLINE( 478)		this->damages->__get(1).StaticCast<  ::flixel::text::FlxText >()->set_text(HX_("",00,00,00,00));
HXLINE( 480)		if ((this->playerHealth <= 0)) {
HXLINE( 483)			this->outcome = ::Outcome_obj::DEFEAT_dyn();
HXLINE( 484)			this->loseSound->play(null(),null(),null());
HXLINE( 485)			this->results->set_text(HX_("DEFEAT!",ce,60,2d,1e));
HXLINE( 486)			this->results->set_visible(true);
HXLINE( 487)			this->results->set_alpha(( (Float)(0) ));
HXLINE( 488)			::flixel::tweens::FlxTween_obj::tween(this->results, ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("alpha",5e,a7,96,21),1)),((Float)0.66), ::Dynamic(::hx::Anon_obj::Create(2)
            				->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::circInOut_dyn())
            				->setFixed(1,HX_("onComplete",f8,d4,7e,5d),this->doneResultsIn_dyn())));
            		}
            		else {
HXLINE( 490)			if ((this->enemyHealth <= 0)) {
HXLINE( 493)				this->outcome = ::Outcome_obj::VICTORY_dyn();
HXLINE( 494)				this->winSound->play(null(),null(),null());
HXLINE( 495)				this->results->set_text(HX_("VICTORY!",2f,7c,99,6e));
HXLINE( 496)				this->results->set_visible(true);
HXLINE( 497)				this->results->set_alpha(( (Float)(0) ));
HXLINE( 498)				::flixel::tweens::FlxTween_obj::tween(this->results, ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("alpha",5e,a7,96,21),1)),((Float)0.66), ::Dynamic(::hx::Anon_obj::Create(2)
            					->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::circInOut_dyn())
            					->setFixed(1,HX_("onComplete",f8,d4,7e,5d),this->doneResultsIn_dyn())));
            			}
            			else {
HXLINE( 503)				this->wait = false;
HXLINE( 504)				this->pointer->set_visible(true);
            			}
            		}
            	}
