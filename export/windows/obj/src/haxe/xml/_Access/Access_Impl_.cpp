...
::String Access_Impl__obj::get_innerData( ::Xml this1){
            	HX_GC_STACKFRAME(&_hx_pos_692ee901efc615a8_215_get_innerData)
HXLINE( 216)		bool it;
HXDLIN( 216)		if ((this1->nodeType != ::Xml_obj::Document)) {
HXLINE( 216)			it = (this1->nodeType != ::Xml_obj::Element);
            		}
            		else {
HXLINE( 216)			it = false;
            		}
...
HXDLIN( 216)		 ::Dynamic it1 =  ::haxe::iterators::ArrayIterator_obj::__alloc( HX_CTX ,this1->children);
HXLINE( 217)		if (!(( (bool)(it1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) ))) {
...
HXLINE( 219)		 ::Xml v = ( ( ::Xml)(it1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 220)		if (( (bool)(it1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )) {
HXLINE( 221)			 ::Xml n = ( ( ::Xml)(it1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 224)				if (!(( (bool)(it1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) ))) {
...
HXLINE( 226)				 ::Xml n2 = ( ( ::Xml)(it1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
...
HXLINE( 227)					_hx_tmp = !(( (bool)(it1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) ));
            				}
            				else {
...
HXLINE( 232)			_hx_tmp = (v->nodeType != ::Xml_obj::CData);
            		}
            		else {
...
HXLINE( 234)			_hx_tmp1 = (v->nodeType == ::Xml_obj::Element);
            		}
            		else {
