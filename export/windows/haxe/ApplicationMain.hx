...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Pixel Climber", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Pixel Climber", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "456";
		app.meta["company"] = "Conecat";
		app.meta["file"] = "Pixel Climber";
		app.meta["name"] = "Pixel Climber";
		app.meta["packageName"] = "com.conecat.pixelClimber";
